![Description](images/Pasted%20image%2020260623231720.png)
# Tổng quan
...
```
![Gửi payload OOB SQLi để xác định DBMS Oracle](images/Pasted%20image%2020260624100057.png)
Thì ta có thể thấy là server đã tra cứu DNS:
![DNS lookup thành công trên Burp Collaborator](images/Pasted%20image%2020260624100037.png)
=> dbms là Oracle
...
![HTTP interaction chứa password trong subdomain](images/Pasted%20image%2020260624100856.png)
...
![Đăng nhập administrator thành công](images/Pasted%20image%2020260624101053.png)
