![Giao diện lab ban đầu](images/Pasted%20image%2020260601202402.png)
# Tổng quan về lab
...
![ORDER BY 3 bị lỗi](images/Pasted%20image%2020260601210615.png)
...
```
![UNION SELECT username password bị lỗi kiểu dữ liệu](images/Pasted%20image%2020260601214052.png)
...
```
![Test kiểu dữ liệu với số và chuỗi thành công](images/Pasted%20image%2020260601214420.png)
